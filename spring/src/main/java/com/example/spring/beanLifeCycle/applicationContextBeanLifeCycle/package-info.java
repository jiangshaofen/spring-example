...
/**
 * applicationContext 中的 bean 生命周期
 * 
 * 自动识别出配置文件中定义的 BeanPostProcessor ,InstantiationAwareBeanPostProcessor，BeanFactoryPostProcessor
 * 并自动将他们注册到应用上下文中，而在BeanFactory 中需要手工调用 addBeanPostProcessor() 进行注册.
 * 
 * 
